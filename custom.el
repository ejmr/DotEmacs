...
(custom-set-faces
 ...
 '(which-func ((((type graphic)) (:foreground "#3777e6" :background nil :weight bold)) (t (:foreground "blue" :background nil :weight bold)))))
