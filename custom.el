...
\"###########.######\" };")) t)
 ...
 '(initial-buffer-choice (quote ejmr-display-dashboard))
...
(custom-set-faces
 ...
 '(which-func ((t (:foreground "darkblue" :slant italic)))))
