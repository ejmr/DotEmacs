...
(custom-set-faces
 ...
 '(mode-line-buffer-id ((t (:foreground "gray75" :weight bold))))
 '(pp^L-highlight ((t (:box (:line-width 3 :style released-button)))))
 '(which-func ((t (:foreground "#fcf" :slant italic)))))
